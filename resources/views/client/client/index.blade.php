                            ...
                            <table class="table table-borderless">
                                ...
                                @foreach($client as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/client/' . $item->id) }}" title="View Client"><button class="btn btn-info btn-xs"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/client/' . $item->id . '/edit') }}" title="Edit Client"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                                            {!! Form::open([
                                                'method'=>'DELETE',
                                                'url' => ['/client', $item->id],
